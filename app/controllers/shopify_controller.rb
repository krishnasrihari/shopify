class ShopifyController < ApplicationController
  ...
  def authorize
    ...
    redirect_to "https://#{params[:shop].gsub(".myshopify.com","")}.myshopify.com/admin/oauth/authorize?client_id=#{SHOPIFY_API_KEY}&redirect_uri=#{root_url}&scope=read_products,read_orders,read_customers"
